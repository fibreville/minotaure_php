...
<div align="center">
  ...
  <font style="font-family: 'Libre Baskerville', Black;font-size: 50px;">Votre
    aventurier</font>
  <br><br><br><br>
    ...
    <tr>
      <td>
        <font style="font-family: 'Libre Baskerville', Black;font-size: 20px;">
            ...
            if ($leader == 1) {
                $lead = "Vous êtes actuellement <b>Leader</b> !<br><br>";
            }
            if ($traitre == 1) {
                $trai = "Vous êtes actuellement <b>Traitre</b> !<br><br>";
            }
            ...
            if ($hp > 0) {
                ...
                if ($choix != "" && $vote == 0 && ($choixtag == "" || ($tag1 == $choixtag || $tag2 == $choixtag || $tag3 == $choixtag))) {
                    ...
                    print "Décision en cours :<br><b>$choix</b><br><br><form action=\"main.php\" method=\"post\">";

                    if ($c1 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"1\"> $c1<br>";
                    }
                    if ($c2 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"2\"> $c2<br>";
                    }
                    if ($c3 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"3\"> $c3<br>";
                    }
                    if ($c4 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"4\"> $c4<br>";
                    }
                    if ($c5 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"5\"> $c5<br>";
                    }
                    if ($c6 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"6\"> $c6<br>";
                    }
                    if ($c7 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"7\"> $c7<br>";
                    }
                    if ($c8 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"8\"> $c8<br>";
                    }
                    if ($c9 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"9\"> $c9<br>";
                    }
                    if ($c10 != "") {
                        print "<input type=\"radio\" name=\"choix\" value=\"10\"> $c10<br><br>";
                    }

                    if ($leader == 1) {
                        print "<input type=checkbox name=lead value=1> Utiliser mon pouvoir de leader<br><br>";
                    }

                    if ($traitre == 1) {
                        print "<input type=checkbox name=traitre value=1> Utiliser mon pouvoir de traitre et annuler le vote choisi<br><br>";
                    }
  ...
  <table align="center" border=1 width=500 cellpadding=5>
    <tr>
      <td>
        <font style="font-family: 'Libre Baskerville', Black;font-size: 20px;">
          <a href="main.php"
             style="text-decoration: none;color: #FF6600">CLIQUEZ ICI POUR ACCEDER AU SONDAGE</a>
        </font>
      </td>
    </tr>
  </table>
